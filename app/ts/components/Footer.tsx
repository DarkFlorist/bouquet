	...
	<footer className='mt-auto w-full'>
		<div className='flex flex-col sm:flex-row w-full gap-6 justify-around items-center'>
			<div className='flex flex-col gap-2'>
				...
				<a href='https://github.com/DarkFlorist/bouquet' target='_blank' className='hover:underline text-white/50'>Github</a>
			</div>
			<div className='flex flex-col gap-2'>
				...
				<a href='https://nftsender.dark.florist/' className='hover:underline text-white/50'>NFT Sender</a>
			</div>
		</div>
