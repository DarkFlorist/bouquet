...
export interface FlashbotsTransactionResponse {
	...
	receipts: () => Promise<Array<providers.TransactionReceipt>>
	bundleHash: string
}
...
export class FlashbotsBundleProvider extends providers.JsonRpcProvider {
	...
	public async sendRawBundle(signedBundledTransactions: Array<string>, targetBlockNumber: number, opts?: FlashbotsOptions): Promise<FlashbotsTransaction> {
		const params = {
	...
	private calculateBundlePricing(bundleTransactions: Array<BlocksApiResponseTransactionDetails | TransactionSimulation>, baseFee: BigNumber) {
	...
	public async getConflictingBundle(targetSignedBundledTransactions: Array<string>, targetBlockNumber: number): Promise<FlashbotsBundleConflictWithGasPricing> {
