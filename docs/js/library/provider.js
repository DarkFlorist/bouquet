...
const addProvider = async (store, provider, clearEvents, appSettings, isInterceptor) => {
...
export const connectBrowserProvider = async (store, blockInfo, signers, appSettings) => {
