...
export declare const createRelaySimulationPayload: (transactions: readonly string[], targetBlock: bigint) => string;
export declare function simulateBundle(bundle: Bundle, fundingAmountMin: bigint, provider: ProviderStore, signers: Signers, blockInfo: BlockInfo, targetBlock: bigint, network: BouquetNetwork): Promise<SimulationResponse>;
export declare function sendBundle(bundle: Bundle, targetBlocks: readonly bigint[], fundingAmountMin: bigint, provider: ProviderStore, signers: Signers, blockInfo: BlockInfo, network: BouquetNetwork): Promise<{
    bundleTransactions: {
