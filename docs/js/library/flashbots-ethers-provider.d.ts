...
export declare class FlashbotsBundleProvider extends providers.JsonRpcProvider {
    ...
    static create(genericProvider: providers.BaseProvider, authSigner: Signer, connectionInfoOrUrl?: utils.ConnectionInfo | string, network?: providers.Networkish): Promise<FlashbotsBundleProvider>;
    ...
    simulate(signedBundledTransactions: Array<string>, blockTag: providers.BlockTag, stateBlockTag?: providers.BlockTag, blockTimestamp?: number): Promise<SimulationResponse>;
...
export {};
//# sourceMappingURL=flashbots-ethers-provider.d.ts.map