...
export const Navbar = ({ provider, appSettings }) => {
    const switchNetwork = async (e) => {
        const elm = e.target;
        if (elm.value !== '1' && elm.value !== '5')
            return;
