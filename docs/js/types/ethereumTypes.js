...
export const EthereumSignatureParity = t.Union(t.Literal('0x0').withParser(LiteralConverterParserFactory('0x0', 'even')), t.Literal('0x1').withParser(LiteralConverterParserFactory('0x1', 'odd')));
