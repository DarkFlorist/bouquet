...
const EthereumEip7702Authorization = t.Intersect(t.Object({
    chainId: EthereumQuantity,
    address: EthereumAddress,
    nonce: EthereumQuantity,
}).asReadonly(), t.Partial({
...
const EthereumUnsignedTransaction7702 = t.Intersect(t.Object({
    type: t.Literal('0x4').withParser(LiteralConverterParserFactory('0x4', '7702')),
    from: EthereumAddress,
    nonce: EthereumQuantity,
    maxFeePerGas: EthereumQuantity,
    maxPriorityFeePerGas: EthereumQuantity,
